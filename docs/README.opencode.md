...
```bash
ls -l ~/.config/opencode/plugins/arbiter-os.js
...
git clone https://github.com/0possum-eth/arbiter-os-v1.git "%USERPROFILE%\.config\opencode\superpowers"
...
del "%USERPROFILE%\.config\opencode\plugins\arbiter-os.js" 2>nul
rmdir "%USERPROFILE%\.config\opencode\skills\superpowers" 2>nul

:: 4. Create plugin symlink (requires Developer Mode or Admin)
mklink "%USERPROFILE%\.config\opencode\plugins\arbiter-os.js" "%USERPROFILE%\.config\opencode\superpowers\.opencode\plugins\arbiter-os.js"
...
```powershell
# 1. Install Superpowers
git clone https://github.com/0possum-eth/arbiter-os-v1.git "$env:USERPROFILE\.config\opencode\superpowers"
...
# 3. Remove existing links (safe for reinstalls)
Remove-Item "$env:USERPROFILE\.config\opencode\plugins\arbiter-os.js" -Force -ErrorAction SilentlyContinue
Remove-Item "$env:USERPROFILE\.config\opencode\skills\superpowers" -Force -ErrorAction SilentlyContinue

# 4. Create plugin symlink (requires Developer Mode or Admin)
New-Item -ItemType SymbolicLink -Path "$env:USERPROFILE\.config\opencode\plugins\arbiter-os.js" -Target "$env:USERPROFILE\.config\opencode\superpowers\.opencode\plugins\arbiter-os.js"
...
# 3. Remove existing links (safe for reinstalls)
rm -f ~/.config/opencode/plugins/arbiter-os.js 2>/dev/null
rm -rf ~/.config/opencode/skills/superpowers 2>/dev/null

# 4. Create plugin symlink (requires Developer Mode or Admin)
cmd //c "mklink \"$(cygpath -w ~/.config/opencode/plugins/arbiter-os.js)\" \"$(cygpath -w ~/.config/opencode/superpowers/.opencode/plugins/arbiter-os.js)\""
...
1. Check plugin exists: `ls ~/.config/opencode/superpowers/.opencode/plugins/arbiter-os.js`
...
- Main documentation: https://github.com/0possum-eth/arbiter-os-v1
